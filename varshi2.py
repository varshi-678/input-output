...
For Banerjee's question "Will you be a wicketkeeper?" Dhoni's confident reply was "I will if i get a chance ".write az program to desplay the answer of dhoni that impressed his master
'''
